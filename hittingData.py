...
class BaseballBatter:
    ...
    def __eq__(self, other):
        if type(self) == type(other):
            return (self.player_id, self.birthState, self.teamID, self.battingAvg, self.position) == (other.player, other.birthState, other.teamID, other.battingAvg, other.position)
        else:
